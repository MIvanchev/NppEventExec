...
Test(csv, success_after_failure, .disabled=true) {
    /* TODO */
}

Test(csv, failure_after_success, .disabled=true) {
    /* TODO */
}

Test(csv, success_after_success, .disabled=true) {
    /* TODO */
}
